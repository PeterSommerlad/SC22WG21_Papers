...
void matrixMultiplicationKernel(cl::sycl::nd_item<dimensions> item, 
  cl::sycl::global_ptr<float> A, cl::sycl::global_ptr<float> B, 
  ...
  /* Invoke kernel */
  {
    ...
    compute_queue.submit(
      [&](cl::sycl::handler& cgh) {
        ...
        cgh.parallel_for<class matrixMultiplicationKernel_functor0>(
          cl::sycl::nd_range<3>(grid_dim * block_dim, block_dim), 
