...
\begin{itemize}
\item update specification section names as of changes made to the working paper after Rapperswil (Requires->(Mandates (compile-time), Expects(contract)), Remarks->Constraints
\item may be: "macros" for \textit{\tcode{DESTROY}} and \textit{\tcode{RESOURCE}} in \tcode{unique_resource} specification
\end{itemize}
