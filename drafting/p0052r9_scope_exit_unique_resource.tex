...
\tcode{D} shall either meet the \oldconcept{CopyConstructible} requirement (Table 24
%\ref{copyconstructible}
), or 
\tcode{D} shall meet the \oldconcept{MoveConstructible} requirement (Table 23
...
If \tcode{is_nothrow_move_assignable_v<R1>} is \tcode{true}, \tcode{R1} shall meet the \oldconcept{MoveAssignable} requirement (Table 25), otherwise \tcode{R1} shall meet the \oldconcept{CopyAssignable} (Table 26) requirement.
If \tcode{is_nothrow_move_assignable_v<D>} is \tcode{true}, \tcode{D} shall meet the \oldconcept{MoveAssignable} requirement (Table 25), otherwise \tcode{D} shall meet the \oldconcept{CopyAssignable} requirement (Table 26).
%\requires %\mandates not useful for oldconcept
