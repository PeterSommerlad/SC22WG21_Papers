...
\tcode{basic_stringbuf<charT, traits, Alloca\-tor>(which | ios_base::in\added{, a}))}~({27.8.2.1}).
\end{itemdescr}
...
\tcode{basic_istream(\&sb)}
and initializing \tcode{sb} with
\tcode{basic_stringbuf<charT, traits, Alloca\-tor>(str, which | ios_base::in\added{, a)})}~({27.8.2.1}).
\end{itemdescr}
...
and initializing \tcode{sb} with
\tcode{basic_stringbuf<charT, traits, Allocator>(which | \brk{}ios_base::out\added{, a}))}~({27.8.2.1}).
\end{itemdescr}
...
and initializing \tcode{sb} with
\tcode{basic_stringbuf<charT, traits, Alloca\-tor>(str, which | ios_base::out\added{, a}))}~({27.8.2.1}).
\end{itemdescr}
