...
\emph{LWG question: should the requirement go as code or as text?}

The following changes will be proposed either by a follow-up paper of if LEWG gives immediate blessing:
...
namespace std {
  ...
  public:
    ...
    explicit basic_ispanstream(ROS&& s)}
      :basic_ispanstream(
         std::span<charT>(const_cast<charT*>(data(s)),size(s)){}\end{codeblock}\end{addedblock}\begin{codeblock}         
