...
\throws
\tcode{runtime_error}
if the argument is not valid, or is \removed{null}\added{constructed from \tcode{nullptr}}.
...
\begin{codeblock}
  template <class charT, class traits@\removed{, class Allocator}@>
    @\textit{T12}@ quoted(@\removed{const }@basic_string@\added{_view}@<charT, traits@\removed{, Allocator}@>@\removed{\&}@ s,
...
\begin{itemdecl}
template <class charT, class traits@\removed{, class Allocator}@>
  @\unspec@ quoted(@\removed{const }@basic_string@\added{_view}@<charT, traits@\removed{, Allocator}@>@\removed{\&}@ s,
  @\itcorr@                   charT delim = charT('"'), charT escape = charT('\\'));
\end{itemdecl}
...
of \tcode{basic_ostream} \removed{with member type \tcode{char_type} the same as
\tcode{charT} and }with member type \tcode{traits_type}, which \removed{in the second
