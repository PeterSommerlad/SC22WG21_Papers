...
\begin{itemize}
\item How do we specify deduction guides in the standard? Synopsis only? Should they be \tcode{explicit} (My gcc version doesn't allow that syntax yet)?
...
\section{Header}
In section 17.5.1.1 Library contents [contents] add an entry to table 14 for the new header \tcode{<scope>}. Because of the new header, there is no need for a feature test macro.
