...
marked \tcode{nodiscard}.}
A \emph{nodiscard call} is a function call expression \added{(7.6.1.2 [expr.call])}
that
calls a function 
...
\added{\emph{nodiscard type}}. 
\added{Also, a \emph{nodiscard call} is an explicit type conversion (7.6.1.8 [expr.static.cast], 7.6.3 [expr.cast], 7.6.1.3 [expr.type.conv])
that constructs an object through a constructor
previously declared \tcode{nodiscard}, or
that initializes an object of a \emph{nodiscard type}.}
