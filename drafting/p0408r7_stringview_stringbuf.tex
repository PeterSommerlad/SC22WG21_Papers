...
\added{This is accomplished by copy constructing the base class and initializing \tcode{mode} with \tcode{rhs.mode}. %% drive by clarification
...
construction. \removed{The openmode, locale and any other state of \tcode{rhs} is
also copied.}
