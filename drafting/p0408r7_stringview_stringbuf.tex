...
\item make conditional noexcept conform with synopsis.
\end{itemize}
...
\begin{codeblock}
  template <class charT, class traits, class Allocator>
    void swap(basic_stringbuf<charT, traits, Allocator>& x,
              basic_stringbuf<charT, traits, Allocator>& y) @\added{noexcept(\seebelow)}@;
\end{codeblock}
...
\begin{itemdescr}
\pnum
\effects Constructs an object of class \tcode{basic_stringbuf}, initializing the base class with \tcode{basic_streambuf()} \iref{streambuf.cons}, initializing \tcode{mode} with \tcode{which}, and  \tcode{buf} with \tcode{std::move(s)}. Then calls \tcode{init\_buf\_ptrs()}.
\end{itemdescr}
...
\pnum
\effects Constructs an object of class \tcode{basic_stringbuf}, initializing the base class with \tcode{basic_streambuf()} \iref{streambuf.cons}, initializing \tcode{mode} with \tcode{which}, and  \tcode{buf} with \tcode{\{s,a\}}. Then calls \tcode{init\_buf\_ptrs()}.
...
\pnum
\effects Constructs an object of class \tcode{basic_stringbuf}, initializing the base class with \tcode{basic_streambuf()} \iref{streambuf.cons}, initializing \tcode{mode} with \tcode{which}, and  \tcode{buf} with \tcode{s}. Then calls \tcode{init\_buf\_ptrs()}.
