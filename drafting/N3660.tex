...
\markboth{N3660 2013-04-19}{N3660 2013-04-19}
%%TODO
...
\date{2013-04-19}                                           % Activate to display a given date or no date
\input{macros}
...
\enternote
This allows a user either to do a \tcode{using namespace std::literals;} to import all literal operators from the standard available through header file inclusion, or to use \tcode{using namespace std::complex_literals;} to just obtain the literals operators for a specific type.
\exitnote
...
%% note removed as per request by STL
%\enternote
