...
_GLIBCXX_BEGIN_NAMESPACE_CONTAINER
  ...
  */
  template<size_t _Nb>
    ...
    private:
      ...
      void
      _M_check_initial_position(const std::basic_string_view<_CharT, _Traits>& __s,
	...
	bitset(std::basic_string_view<_CharT, _Traits> __s,
	       size_t __position = 0,
      typename std::basic_string_view<_CharT,_Traits>::size_type __n
	...
	: _Base()
	{
	  ...
	  _M_copy_from_string_view(__s, __position,
			      std::basic_string_view<_CharT, _Traits>::npos,
			      _CharT('0'), _CharT('1'));
	}
#if 0
	...
	return to_string<char, std::char_traits<char>,
      ...
      template<class _CharT, class _Traits>
	void
	_M_copy_from_string_view( std::basic_string_view<_CharT,
			    _Traits> __s, size_t __pos, size_t __n,
  ...
  */
  ...
  //@}
#if 0
  template<typename _CharT,size_t _Nb>
  bitset(_CharT const (& )[_Nb]) ->bitset<_Nb>;
#endif
...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<size_t _Nb>
    struct hash<_GLIBCXX_STD_C::ext::bitset<_Nb>>
    : public __hash_base<size_t, _GLIBCXX_STD_C::ext::bitset<_Nb>>
    {
      size_t
      operator()(const _GLIBCXX_STD_C::ext::bitset<_Nb>& __b) const noexcept
      {
  ...
  template<>
    struct hash<_GLIBCXX_STD_C::ext::bitset<0>>
    : public __hash_base<size_t, _GLIBCXX_STD_C::ext::bitset<0>>
    {
      size_t
      operator()(const _GLIBCXX_STD_C::ext::bitset<0>&) const noexcept
      { return 0; }
    };
