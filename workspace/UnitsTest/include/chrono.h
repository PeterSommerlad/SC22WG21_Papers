...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<typename _CT, typename _Period1, typename _Period2>
    ...
    {
    private:
      static inline constexpr auto __gcd_num= __static_gcd<_Period1::num, _Period2::num>;
      static inline constexpr auto __gcd_den= __static_gcd<_Period1::den, _Period2::den> ;
      typedef typename _CT::type __cr;
      typedef ratio<__gcd_num,
        (_Period1::den / __gcd_den) * _Period2::den> __r;
    public:
